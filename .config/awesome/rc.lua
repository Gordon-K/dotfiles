...
local editor           = os.getenv("EDITOR") or "neovide"
...
local keybindings = {
  ...
  {{}, "XF86MonBrightnessDown", function() awful.spawn("brightnessctl s 10-") end},
  {{}, "XF86MonBrightnessUp", function() awful.spawn("brightnessctl s 10+") end},
...
modes.launcher = gears.table.join(
  {
    ...
    },
    {
      ...
      pattern = { "F4" },
      handler = function() awful.spawn("brightnessctl s 10-") end
    },
    {
